...
export const StatCard = ({ 
  ...
  if (highlight && highlightContent) {
    return (
      <div className="bg-info rounded-2xl p-6 relative overflow-hidden glass-strong hover-lift hover-glow">
        {highlightContent}
      </div>
    );
  }
  ...
  return (
    <div className="bg-card rounded-2xl p-6 border border-border glass hover-lift">
